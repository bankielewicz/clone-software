...
- Any product-specific runtime, browser driver, comparator, scanner, compiler, or package manager already installed before the corresponding plan executes. The skill does not install external tools or dependencies.
