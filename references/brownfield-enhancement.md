...
Load this reference when the user asks to enhance, extend, modernize, refactor, upgrade, migrate, or harden an existing repository. It governs both `enhancement-plan` and `enhancement-build` workstreams in tool `2.2.0`.
